...
export type LabelChatbotCategorySelectColumn =
	| 'categoryId'
	| 'chatbotId'
	| 'labelId'
...
export type LabelChatbotCategoryUpdateColumn =
	| 'categoryId'
	| 'chatbotId'
	| 'labelId'
...
export interface mutation_root {
	...
	updateLabelChatbotCategoryMany:
		| (LabelChatbotCategoryMutationResponse | null)[]
		| null
...
export interface CategoryGenqlSelection {
	...
	/** An array relationship */
	metadataLabels?: LabelChatbotCategoryGenqlSelection & {
		__args?: {
			/** distinct select on columns */
	...
	/** An aggregate relationship */
	metadataLabelsAggregate?: LabelChatbotCategoryAggregateGenqlSelection & {
		__args?: {
			/** distinct select on columns */
			distinctOn?: LabelChatbotCategorySelectColumn[] | null
			/** limit the number of rows returned */
...
export interface CategoryBoolExp {
	...
	metadataLabels?: LabelChatbotCategoryBoolExp | null
	metadataLabelsAggregate?: LabelChatbotCategoryAggregateBoolExp | null
...
export interface CategoryInsertInput {
	...
	metadataLabels?: LabelChatbotCategoryArrRelInsertInput | null
	name?: Scalars['String'] | null
}
...
export interface CategoryOrderBy {
	...
	metadataLabelsAggregate?: LabelChatbotCategoryAggregateOrderBy | null
	name?: OrderBy | null
}
...
export interface ChatAggregateBoolExp {
	count?: chatAggregateBoolExpCount | null
}
...
export interface ChatAggregateOrderBy {
	avg?: ChatAvgOrderBy | null
	count?: OrderBy | null
	max?: ChatMaxOrderBy | null
	min?: ChatMinOrderBy | null
	stddev?: ChatStddevOrderBy | null
	stddevPop?: ChatStddevPopOrderBy | null
	stddevSamp?: ChatStddevSampOrderBy | null
	sum?: ChatSumOrderBy | null
	varPop?: ChatVarPopOrderBy | null
	varSamp?: ChatVarSampOrderBy | null
	variance?: ChatVarianceOrderBy | null
}
...
export interface ChatBoolExp {
	_and?: ChatBoolExp[] | null
	_not?: ChatBoolExp | null
	_or?: ChatBoolExp[] | null
	addedBy?: UuidComparisonExp | null
	chatId?: IntComparisonExp | null
	chatbot?: ChatbotBoolExp | null
	chatbotId?: IntComparisonExp | null
	conversationLink?: StringComparisonExp | null
...
export interface ChatMaxOrderBy {
	addedBy?: OrderBy | null
	chatId?: OrderBy | null
	chatbotId?: OrderBy | null
	conversationLink?: OrderBy | null
}
...
export interface ChatPkColumnsInput {
	chatId: Scalars['Int']
}
...
/** Initial value of the column from where the streaming should start */
export interface ChatStreamCursorValueInput {
	addedBy?: Scalars['uuid'] | null
	chatId?: Scalars['Int'] | null
	chatbotId?: Scalars['Int'] | null
	conversationLink?: Scalars['String'] | null
...
export interface ChatbotGenqlSelection {
	...
	/** An aggregate relationship */
	chatsAggregate?: ChatAggregateGenqlSelection & {
		__args?: {
			/** distinct select on columns */
			distinctOn?: ChatSelectColumn[] | null
			/** limit the number of rows returned */
...
export interface ChatbotBoolExp {
	...
	chatbotId?: IntComparisonExp | null
	chats?: ChatBoolExp | null
	chatsAggregate?: ChatAggregateBoolExp | null
...
export interface ChatbotInsertInput {
	...
	chatbotId?: Scalars['Int'] | null
	chats?: ChatArrRelInsertInput | null
...
export interface ChatbotOrderBy {
	...
	chatbotId?: OrderBy | null
	chatsAggregate?: ChatAggregateOrderBy | null
...
export interface LabelAggregateFieldsGenqlSelection {
	...
	count?:
		| {
				__args: {
					columns?: LabelSelectColumn[] | null
					distinct?: Scalars['Boolean'] | null
				}
		  }
		| boolean
...
export interface LabelBoolExp {
	_and?: LabelBoolExp[] | null
	_not?: LabelBoolExp | null
	_or?: LabelBoolExp[] | null
	advancedLabels?: BooleanComparisonExp | null
	categories?: StringComparisonExp | null
	labelId?: IntComparisonExp | null
	metadataLabels?: LabelChatbotCategoryBoolExp | null
	metadataLabelsAggregate?: LabelChatbotCategoryAggregateBoolExp | null
	questions?: StringComparisonExp | null
	subCategories?: StringComparisonExp | null
	tags?: StringComparisonExp | null
}
...
export interface LabelChatbotCategoryAggregateBoolExp {
	count?: labelChatbotCategoryAggregateBoolExpCount | null
}
...
export interface LabelChatbotCategoryAggregateFieldsGenqlSelection {
	...
	count?:
		| {
				__args: {
					columns?: LabelChatbotCategorySelectColumn[] | null
					distinct?: Scalars['Boolean'] | null
				}
		  }
		| boolean
...
export interface LabelChatbotCategoryAggregateOrderBy {
	avg?: LabelChatbotCategoryAvgOrderBy | null
	count?: OrderBy | null
	max?: LabelChatbotCategoryMaxOrderBy | null
	min?: LabelChatbotCategoryMinOrderBy | null
	stddev?: LabelChatbotCategoryStddevOrderBy | null
	stddevPop?: LabelChatbotCategoryStddevPopOrderBy | null
	stddevSamp?: LabelChatbotCategoryStddevSampOrderBy | null
	sum?: LabelChatbotCategorySumOrderBy | null
	varPop?: LabelChatbotCategoryVarPopOrderBy | null
	varSamp?: LabelChatbotCategoryVarSampOrderBy | null
	variance?: LabelChatbotCategoryVarianceOrderBy | null
}

/** input type for inserting array relation for remote table "label_chatbot_category" */
export interface LabelChatbotCategoryArrRelInsertInput {
...
export interface LabelChatbotCategoryAvgOrderBy {
	categoryId?: OrderBy | null
	chatbotId?: OrderBy | null
	labelId?: OrderBy | null
}
...
export interface LabelChatbotCategoryBoolExp {
	_and?: LabelChatbotCategoryBoolExp[] | null
	_not?: LabelChatbotCategoryBoolExp | null
	_or?: LabelChatbotCategoryBoolExp[] | null
	category?: CategoryBoolExp | null
	categoryId?: IntComparisonExp | null
	chatbot?: ChatbotBoolExp | null
	chatbotId?: IntComparisonExp | null
	label?: LabelBoolExp | null
	labelId?: IntComparisonExp | null
}

/** input type for incrementing numeric columns in table "label_chatbot_category" */
export interface LabelChatbotCategoryIncInput {
	categoryId?: Scalars['Int'] | null
	chatbotId?: Scalars['Int'] | null
	labelId?: Scalars['Int'] | null
}
...
export interface LabelChatbotCategoryInsertInput {
	category?: CategoryObjRelInsertInput | null
	categoryId?: Scalars['Int'] | null
	chatbot?: ChatbotObjRelInsertInput | null
	chatbotId?: Scalars['Int'] | null
	label?: LabelObjRelInsertInput | null
	labelId?: Scalars['Int'] | null
}
...
export interface LabelChatbotCategoryMaxOrderBy {
	categoryId?: OrderBy | null
	chatbotId?: OrderBy | null
	labelId?: OrderBy | null
}
...
export interface LabelChatbotCategoryMinOrderBy {
	categoryId?: OrderBy | null
	chatbotId?: OrderBy | null
	labelId?: OrderBy | null
}
...
export interface LabelChatbotCategoryOnConflict {
...
export interface LabelChatbotCategoryOrderBy {
	category?: CategoryOrderBy | null
	categoryId?: OrderBy | null
	chatbot?: ChatbotOrderBy | null
	chatbotId?: OrderBy | null
	label?: LabelOrderBy | null
	labelId?: OrderBy | null
}

/** primary key columns input for table: label_chatbot_category */
export interface LabelChatbotCategoryPkColumnsInput {
	categoryId: Scalars['Int']
	chatbotId: Scalars['Int']
	labelId: Scalars['Int']
}
...
export interface LabelChatbotCategorySetInput {
	categoryId?: Scalars['Int'] | null
	chatbotId?: Scalars['Int'] | null
	labelId?: Scalars['Int'] | null
}
...
export interface LabelChatbotCategoryStddevOrderBy {
	categoryId?: OrderBy | null
	chatbotId?: OrderBy | null
	labelId?: OrderBy | null
}
...
export interface LabelChatbotCategoryStddevPopOrderBy {
	categoryId?: OrderBy | null
	chatbotId?: OrderBy | null
	labelId?: OrderBy | null
}
...
export interface LabelChatbotCategoryStddevSampOrderBy {
	categoryId?: OrderBy | null
	chatbotId?: OrderBy | null
	labelId?: OrderBy | null
}
...
/** Initial value of the column from where the streaming should start */
export interface LabelChatbotCategoryStreamCursorValueInput {
	categoryId?: Scalars['Int'] | null
	chatbotId?: Scalars['Int'] | null
	labelId?: Scalars['Int'] | null
}
...
export interface LabelChatbotCategorySumOrderBy {
	categoryId?: OrderBy | null
	chatbotId?: OrderBy | null
	labelId?: OrderBy | null
}
...
export interface LabelChatbotCategoryVarPopOrderBy {
	categoryId?: OrderBy | null
	chatbotId?: OrderBy | null
	labelId?: OrderBy | null
}
...
export interface LabelChatbotCategoryVarSampOrderBy {
	categoryId?: OrderBy | null
	chatbotId?: OrderBy | null
	labelId?: OrderBy | null
}
...
export interface LabelChatbotCategoryVarianceOrderBy {
	categoryId?: OrderBy | null
	chatbotId?: OrderBy | null
	labelId?: OrderBy | null
}
...
export interface LabelOrderBy {
	advancedLabels?: OrderBy | null
	categories?: OrderBy | null
	labelId?: OrderBy | null
	metadataLabelsAggregate?: LabelChatbotCategoryAggregateOrderBy | null
	questions?: OrderBy | null
	subCategories?: OrderBy | null
	tags?: OrderBy | null
}
...
/** Initial value of the column from where the streaming should start */
export interface LabelStreamCursorValueInput {
	advancedLabels?: Scalars['Boolean'] | null
	categories?: Scalars['String'] | null
	labelId?: Scalars['Int'] | null
	questions?: Scalars['String'] | null
...
export interface chatAggregateBoolExpCount {
	arguments?: ChatSelectColumn[] | null
	distinct?: Scalars['Boolean'] | null
	filter?: ChatBoolExp | null
...
export interface labelChatbotCategoryAggregateBoolExpCount {
	arguments?: LabelChatbotCategorySelectColumn[] | null
	distinct?: Scalars['Boolean'] | null
	filter?: LabelChatbotCategoryBoolExp | null
	predicate: IntComparisonExp
}
...
export interface mutation_rootGenqlSelection {
	...
	/** delete data from the table: "chat" */
	deleteChat?: ChatMutationResponseGenqlSelection & {
		__args: {
			/** filter the rows which have to be deleted */
			where: ChatBoolExp
		}
	...
	/** delete data from the table: "label" */
	deleteLabel?: LabelMutationResponseGenqlSelection & {
		__args: {
			/** filter the rows which have to be deleted */
			where: LabelBoolExp
		}
	...
	/** delete single row from the table: "label" */
	deleteLabelByPk?: LabelGenqlSelection & {
		__args: { labelId: Scalars['Int'] }
	}
	/** delete data from the table: "label_chatbot_category" */
	deleteLabelChatbotCategory?: LabelChatbotCategoryMutationResponseGenqlSelection & {
		__args: {
			/** filter the rows which have to be deleted */
			where: LabelChatbotCategoryBoolExp
		}
	...
	/** delete single row from the table: "label_chatbot_category" */
	deleteLabelChatbotCategoryByPk?: LabelChatbotCategoryGenqlSelection & {
		__args: {
			categoryId: Scalars['Int']
			chatbotId: Scalars['Int']
			labelId: Scalars['Int']
	...
	/** insert data into the table: "chat" */
	insertChat?: ChatMutationResponseGenqlSelection & {
		__args: {
			/** the rows to be inserted */
	...
	/** insert a single row into the table: "chat" */
	insertChatOne?: ChatGenqlSelection & {
		__args: {
			/** the row to be inserted */
	...
	/** insert data into the table: "label" */
	insertLabel?: LabelMutationResponseGenqlSelection & {
		__args: {
			/** the rows to be inserted */
	...
	/** insert data into the table: "label_chatbot_category" */
	insertLabelChatbotCategory?: LabelChatbotCategoryMutationResponseGenqlSelection & {
		__args: {
			/** the rows to be inserted */
	...
	/** insert a single row into the table: "label_chatbot_category" */
	insertLabelChatbotCategoryOne?: LabelChatbotCategoryGenqlSelection & {
		__args: {
			/** the row to be inserted */
	...
	/** insert a single row into the table: "label" */
	insertLabelOne?: LabelGenqlSelection & {
		__args: {
			/** the row to be inserted */
	...
	/** update data of the table: "chat" */
	updateChat?: ChatMutationResponseGenqlSelection & {
		__args: {
			/** increments the numeric columns with given value of the filtered values */
			_inc?: ChatIncInput | null
			/** sets the columns of the filtered rows to the given values */
	...
	/** update single row of the table: "chat" */
	updateChatByPk?: ChatGenqlSelection & {
		__args: {
			/** increments the numeric columns with given value of the filtered values */
			_inc?: ChatIncInput | null
			/** sets the columns of the filtered rows to the given values */
	...
	/** update multiples rows of table: "chat" */
	updateChatMany?: ChatMutationResponseGenqlSelection & {
		__args: {
			/** updates to execute, in order */
			updates: ChatUpdates[]
		}
	...
	/** update data of the table: "label" */
	updateLabel?: LabelMutationResponseGenqlSelection & {
		__args: {
			/** increments the numeric columns with given value of the filtered values */
			_inc?: LabelIncInput | null
			/** sets the columns of the filtered rows to the given values */
	...
	/** update single row of the table: "label" */
	updateLabelByPk?: LabelGenqlSelection & {
		__args: {
			/** increments the numeric columns with given value of the filtered values */
			_inc?: LabelIncInput | null
			/** sets the columns of the filtered rows to the given values */
	...
	/** update data of the table: "label_chatbot_category" */
	updateLabelChatbotCategory?: LabelChatbotCategoryMutationResponseGenqlSelection & {
		__args: {
			/** increments the numeric columns with given value of the filtered values */
			_inc?: LabelChatbotCategoryIncInput | null
			/** sets the columns of the filtered rows to the given values */
	...
	/** update single row of the table: "label_chatbot_category" */
	updateLabelChatbotCategoryByPk?: LabelChatbotCategoryGenqlSelection & {
		__args: {
			/** increments the numeric columns with given value of the filtered values */
			_inc?: LabelChatbotCategoryIncInput | null
			/** sets the columns of the filtered rows to the given values */
	...
	/** update multiples rows of table: "label_chatbot_category" */
	updateLabelChatbotCategoryMany?: LabelChatbotCategoryMutationResponseGenqlSelection & {
		__args: {
			/** updates to execute, in order */
	...
	/** update multiples rows of table: "label" */
	updateLabelMany?: LabelMutationResponseGenqlSelection & {
		__args: {
			/** updates to execute, in order */
...
export interface query_rootGenqlSelection {
	...
	/** fetch aggregated fields from the table: "chat" */
	chatAggregate?: ChatAggregateGenqlSelection & {
		__args?: {
			/** distinct select on columns */
			distinctOn?: ChatSelectColumn[] | null
			/** limit the number of rows returned */
	...
	/** fetch aggregated fields from the table: "label" */
	labelAggregate?: LabelAggregateGenqlSelection & {
		__args?: {
			/** distinct select on columns */
			distinctOn?: LabelSelectColumn[] | null
			/** limit the number of rows returned */
	...
	/** fetch data from the table: "label_chatbot_category" */
	labelChatbotCategory?: LabelChatbotCategoryGenqlSelection & {
		__args?: {
			/** distinct select on columns */
			distinctOn?: LabelChatbotCategorySelectColumn[] | null
			/** limit the number of rows returned */
	...
	/** fetch aggregated fields from the table: "label_chatbot_category" */
	labelChatbotCategoryAggregate?: LabelChatbotCategoryAggregateGenqlSelection & {
		__args?: {
			/** distinct select on columns */
			distinctOn?: LabelChatbotCategorySelectColumn[] | null
			/** limit the number of rows returned */
	...
	/** fetch data from the table: "label_chatbot_category" using primary key columns */
	labelChatbotCategoryByPk?: LabelChatbotCategoryGenqlSelection & {
		__args: {
			categoryId: Scalars['Int']
			chatbotId: Scalars['Int']
			labelId: Scalars['Int']
...
export interface subscription_rootGenqlSelection {
	...
	/** fetch data from the table in a streaming manner: "label_chatbot_category" */
	labelChatbotCategoryStream?: LabelChatbotCategoryGenqlSelection & {
		__args: {
			/** maximum number of rows returned in a single batch */
			batchSize: Scalars['Int']
			/** cursor to stream the results returned by the query */
	...
	/** fetch data from the table in a streaming manner: "label" */
	labelStream?: LabelGenqlSelection & {
		__args: {
			/** maximum number of rows returned in a single batch */
			batchSize: Scalars['Int']
			/** cursor to stream the results returned by the query */
...
export const isChatAggregate = (
	obj?: { __typename?: any } | null,
): obj is ChatAggregate => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isChatAggregate"')
...
export const isChatAggregateFields = (
	obj?: { __typename?: any } | null,
): obj is ChatAggregateFields => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isChatAggregateFields"')
	return ChatAggregateFields_possibleTypes.includes(obj.__typename)
}

const ChatAvgFields_possibleTypes: string[] = ['ChatAvgFields']
export const isChatAvgFields = (
	obj?: { __typename?: any } | null,
): obj is ChatAvgFields => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isChatAvgFields"')
	return ChatAvgFields_possibleTypes.includes(obj.__typename)
}

const ChatMaxFields_possibleTypes: string[] = ['ChatMaxFields']
export const isChatMaxFields = (
	obj?: { __typename?: any } | null,
): obj is ChatMaxFields => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isChatMaxFields"')
	return ChatMaxFields_possibleTypes.includes(obj.__typename)
}

const ChatMinFields_possibleTypes: string[] = ['ChatMinFields']
export const isChatMinFields = (
	obj?: { __typename?: any } | null,
): obj is ChatMinFields => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isChatMinFields"')
...
export const isChatMutationResponse = (
	obj?: { __typename?: any } | null,
): obj is ChatMutationResponse => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isChatMutationResponse"')
...
export const isChatStddevFields = (
	obj?: { __typename?: any } | null,
): obj is ChatStddevFields => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isChatStddevFields"')
...
export const isChatStddevPopFields = (
	obj?: { __typename?: any } | null,
): obj is ChatStddevPopFields => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isChatStddevPopFields"')
...
export const isChatStddevSampFields = (
	obj?: { __typename?: any } | null,
): obj is ChatStddevSampFields => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isChatStddevSampFields"')
	return ChatStddevSampFields_possibleTypes.includes(obj.__typename)
}

const ChatSumFields_possibleTypes: string[] = ['ChatSumFields']
export const isChatSumFields = (
	obj?: { __typename?: any } | null,
): obj is ChatSumFields => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isChatSumFields"')
	return ChatSumFields_possibleTypes.includes(obj.__typename)
}

const ChatVarPopFields_possibleTypes: string[] = ['ChatVarPopFields']
export const isChatVarPopFields = (
	obj?: { __typename?: any } | null,
): obj is ChatVarPopFields => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isChatVarPopFields"')
...
export const isChatVarSampFields = (
	obj?: { __typename?: any } | null,
): obj is ChatVarSampFields => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isChatVarSampFields"')
...
export const isChatVarianceFields = (
	obj?: { __typename?: any } | null,
): obj is ChatVarianceFields => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isChatVarianceFields"')
...
export const isChatbotCategoryVarSampFields = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isChatbotCategoryVarSampFields"')
...
export const isLabelAggregate = (
	obj?: { __typename?: any } | null,
): obj is LabelAggregate => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isLabelAggregate"')
...
export const isLabelAggregateFields = (
	obj?: { __typename?: any } | null,
): obj is LabelAggregateFields => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isLabelAggregateFields"')
...
export const isLabelAvgFields = (
	obj?: { __typename?: any } | null,
): obj is LabelAvgFields => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isLabelAvgFields"')
...
export const isLabelChatbotCategory = (
	obj?: { __typename?: any } | null,
): obj is LabelChatbotCategory => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isLabelChatbotCategory"')
	return LabelChatbotCategory_possibleTypes.includes(obj.__typename)
}

const LabelChatbotCategoryAggregate_possibleTypes: string[] = [
	'LabelChatbotCategoryAggregate',
]
export const isLabelChatbotCategoryAggregate = (
	obj?: { __typename?: any } | null,
): obj is LabelChatbotCategoryAggregate => {
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isLabelChatbotCategoryAggregate"',
		)
	return LabelChatbotCategoryAggregate_possibleTypes.includes(obj.__typename)
}

const LabelChatbotCategoryAggregateFields_possibleTypes: string[] = [
	'LabelChatbotCategoryAggregateFields',
]
export const isLabelChatbotCategoryAggregateFields = (
	obj?: { __typename?: any } | null,
): obj is LabelChatbotCategoryAggregateFields => {
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isLabelChatbotCategoryAggregateFields"',
		)
	return LabelChatbotCategoryAggregateFields_possibleTypes.includes(
		obj.__typename,
	)
}

const LabelChatbotCategoryAvgFields_possibleTypes: string[] = [
	'LabelChatbotCategoryAvgFields',
]
export const isLabelChatbotCategoryAvgFields = (
	obj?: { __typename?: any } | null,
): obj is LabelChatbotCategoryAvgFields => {
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isLabelChatbotCategoryAvgFields"',
		)
	return LabelChatbotCategoryAvgFields_possibleTypes.includes(obj.__typename)
}

const LabelChatbotCategoryMaxFields_possibleTypes: string[] = [
	'LabelChatbotCategoryMaxFields',
]
export const isLabelChatbotCategoryMaxFields = (
	obj?: { __typename?: any } | null,
): obj is LabelChatbotCategoryMaxFields => {
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isLabelChatbotCategoryMaxFields"',
		)
	return LabelChatbotCategoryMaxFields_possibleTypes.includes(obj.__typename)
}

const LabelChatbotCategoryMinFields_possibleTypes: string[] = [
	'LabelChatbotCategoryMinFields',
]
export const isLabelChatbotCategoryMinFields = (
	obj?: { __typename?: any } | null,
): obj is LabelChatbotCategoryMinFields => {
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isLabelChatbotCategoryMinFields"',
		)
	return LabelChatbotCategoryMinFields_possibleTypes.includes(obj.__typename)
}

const LabelChatbotCategoryMutationResponse_possibleTypes: string[] = [
	'LabelChatbotCategoryMutationResponse',
]
export const isLabelChatbotCategoryMutationResponse = (
	obj?: { __typename?: any } | null,
): obj is LabelChatbotCategoryMutationResponse => {
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isLabelChatbotCategoryMutationResponse"',
		)
	return LabelChatbotCategoryMutationResponse_possibleTypes.includes(
		obj.__typename,
	)
}

const LabelChatbotCategoryStddevFields_possibleTypes: string[] = [
	'LabelChatbotCategoryStddevFields',
]
export const isLabelChatbotCategoryStddevFields = (
	obj?: { __typename?: any } | null,
): obj is LabelChatbotCategoryStddevFields => {
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isLabelChatbotCategoryStddevFields"',
		)
	return LabelChatbotCategoryStddevFields_possibleTypes.includes(obj.__typename)
}

const LabelChatbotCategoryStddevPopFields_possibleTypes: string[] = [
	'LabelChatbotCategoryStddevPopFields',
]
export const isLabelChatbotCategoryStddevPopFields = (
	obj?: { __typename?: any } | null,
): obj is LabelChatbotCategoryStddevPopFields => {
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isLabelChatbotCategoryStddevPopFields"',
		)
	return LabelChatbotCategoryStddevPopFields_possibleTypes.includes(
		obj.__typename,
	)
}

const LabelChatbotCategoryStddevSampFields_possibleTypes: string[] = [
	'LabelChatbotCategoryStddevSampFields',
]
export const isLabelChatbotCategoryStddevSampFields = (
	obj?: { __typename?: any } | null,
): obj is LabelChatbotCategoryStddevSampFields => {
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isLabelChatbotCategoryStddevSampFields"',
		)
	return LabelChatbotCategoryStddevSampFields_possibleTypes.includes(
		obj.__typename,
	)
}

const LabelChatbotCategorySumFields_possibleTypes: string[] = [
	'LabelChatbotCategorySumFields',
]
export const isLabelChatbotCategorySumFields = (
	obj?: { __typename?: any } | null,
): obj is LabelChatbotCategorySumFields => {
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isLabelChatbotCategorySumFields"',
		)
	return LabelChatbotCategorySumFields_possibleTypes.includes(obj.__typename)
}

const LabelChatbotCategoryVarPopFields_possibleTypes: string[] = [
	'LabelChatbotCategoryVarPopFields',
]
export const isLabelChatbotCategoryVarPopFields = (
	obj?: { __typename?: any } | null,
): obj is LabelChatbotCategoryVarPopFields => {
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isLabelChatbotCategoryVarPopFields"',
		)
	return LabelChatbotCategoryVarPopFields_possibleTypes.includes(obj.__typename)
}

const LabelChatbotCategoryVarSampFields_possibleTypes: string[] = [
	'LabelChatbotCategoryVarSampFields',
]
export const isLabelChatbotCategoryVarSampFields = (
	obj?: { __typename?: any } | null,
): obj is LabelChatbotCategoryVarSampFields => {
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isLabelChatbotCategoryVarSampFields"',
		)
	return LabelChatbotCategoryVarSampFields_possibleTypes.includes(
		obj.__typename,
	)
}

const LabelChatbotCategoryVarianceFields_possibleTypes: string[] = [
	'LabelChatbotCategoryVarianceFields',
]
export const isLabelChatbotCategoryVarianceFields = (
	obj?: { __typename?: any } | null,
): obj is LabelChatbotCategoryVarianceFields => {
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isLabelChatbotCategoryVarianceFields"',
		)
	return LabelChatbotCategoryVarianceFields_possibleTypes.includes(
		obj.__typename,
	)
}

const LabelMaxFields_possibleTypes: string[] = ['LabelMaxFields']
export const isLabelMaxFields = (
	obj?: { __typename?: any } | null,
): obj is LabelMaxFields => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isLabelMaxFields"')
	return LabelMaxFields_possibleTypes.includes(obj.__typename)
}

const LabelMinFields_possibleTypes: string[] = ['LabelMinFields']
export const isLabelMinFields = (
	obj?: { __typename?: any } | null,
): obj is LabelMinFields => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isLabelMinFields"')
...
export const isLabelMutationResponse = (
	obj?: { __typename?: any } | null,
): obj is LabelMutationResponse => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isLabelMutationResponse"')
...
export const isLabelStddevFields = (
	obj?: { __typename?: any } | null,
): obj is LabelStddevFields => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isLabelStddevFields"')
...
export const isLabelStddevPopFields = (
	obj?: { __typename?: any } | null,
): obj is LabelStddevPopFields => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isLabelStddevPopFields"')
...
export const isLabelStddevSampFields = (
	obj?: { __typename?: any } | null,
): obj is LabelStddevSampFields => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isLabelStddevSampFields"')
...
export const isLabelSumFields = (
	obj?: { __typename?: any } | null,
): obj is LabelSumFields => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isLabelSumFields"')
...
export const isLabelVarPopFields = (
	obj?: { __typename?: any } | null,
): obj is LabelVarPopFields => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isLabelVarPopFields"')
...
export const isLabelVarSampFields = (
	obj?: { __typename?: any } | null,
): obj is LabelVarSampFields => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isLabelVarSampFields"')
...
export const isLabelVarianceFields = (
	obj?: { __typename?: any } | null,
): obj is LabelVarianceFields => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isLabelVarianceFields"')
...
export const isPromptChatbotAggregateFields = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isPromptChatbotAggregateFields"')
...
export const isPromptChatbotStddevPopFields = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isPromptChatbotStddevPopFields"')
