export default {
  scalars: [
    0, 7, 17, 25, 39, 50, 62, 88, 99, 111, 119, 131, 143, 155, 164, 168, 170,
    171, 172, 188, 199, 211, 219, 229, 237, 246, 255, 259, 268, 278, 286, 295,
    299, 301, 307, 308, 318, 322, 324, 334, 345, 346, 347, 359, 385, 396, 408,
    416, 428, 444, 453, 457, 459, 470, 481, 493, 514, 524, 528, 544, 549, 560,
    572, 573, 574, 586, 599, 608, 612, 618, 627, 631, 637, 646, 650, 656, 666,
    677, 687, 691, 693, 712, 714, 715,
  ],
  types: {
    Boolean: {},
    ...
    Category: {
      ...
      chatbots: [
        79,
        {
          distinctOn: [99, "[ChatbotCategorySelectColumn!]"],
          limit: [172],
          offset: [172],
          orderBy: [97, "[ChatbotCategoryOrderBy!]"],
          where: [87],
        },
      ],
      chatbotsAggregate: [
      ...
      metadataLabels: [
        179,
        {
          distinctOn: [199, "[LabelChatbotCategorySelectColumn!]"],
          limit: [172],
          offset: [172],
          orderBy: [197, "[LabelChatbotCategoryOrderBy!]"],
          where: [187],
        },
      ],
    ...
    CategoryBoolExp: {
      ...
      categoryId: [173],
      chatbots: [87],
      chatbotsAggregate: [81],
      metadataLabels: [187],
      metadataLabelsAggregate: [181],
      name: [550],
      __typename: [549],
    },
    CategoryConstraint: {},
    ...
    CategoryOrderBy: {
      categoryId: [324],
      chatbotsAggregate: [83],
      metadataLabelsAggregate: [183],
      name: [324],
      __typename: [549],
    },
    ...
    Chatbot: {
      ...
      preferences: [
        325,
        {
          distinctOn: [345, "[PreferenceSelectColumn!]"],
          limit: [172],
          offset: [172],
          orderBy: [343, "[PreferenceOrderBy!]"],
          where: [333],
        },
      ],
      ...
      prompts: [
        376,
        {
          distinctOn: [396, "[PromptChatbotSelectColumn!]"],
          limit: [172],
          offset: [172],
          orderBy: [394, "[PromptChatbotOrderBy!]"],
          where: [384],
        },
      ],
      promptsAggregate: [
      ...
      threads: [
        551,
        {
          distinctOn: [572, "[ThreadSelectColumn!]"],
          limit: [172],
          offset: [172],
          orderBy: [570, "[ThreadOrderBy!]"],
          where: [559],
        },
      ],
      threadsAggregate: [
    ...
    ChatbotAggregateFields: {
      ...
      count: [
        172,
        {
          columns: [131, "[ChatbotSelectColumn!]"],
          distinct: [0],
        },
      ],
      max: [122],
    ...
    ChatbotBoolExp: {
      ...
      avatar: [550],
      categories: [87],
      categoriesAggregate: [81],
      chatbotId: [173],
      chats: [38],
      chatsAggregate: [32],
      complexityEnum: [154],
      createdBy: [550],
      defaultComplexity: [550],
      defaultLength: [550],
      defaultTone: [550],
      defaultType: [550],
      description: [550],
      ...
      name: [550],
      preferences: [333],
      preferencesAggregate: [327],
      prompts: [384],
      promptsAggregate: [378],
      threads: [559],
      threadsAggregate: [553],
      toneEnum: [617],
      typeEnum: [636],
      __typename: [549],
    },
    ...
    ChatbotCategoryAggregateFields: {
      ...
      count: [
        172,
        {
          columns: [99, "[ChatbotCategorySelectColumn!]"],
          distinct: [0],
        },
      ],
      max: [91],
    ...
    ChatbotOrderBy: {
      ...
      metadataLabelsAggregate: [183],
      name: [324],
      preferencesAggregate: [329],
      promptsAggregate: [380],
      threadsAggregate: [555],
      toneEnum: [625],
      typeEnum: [644],
      __typename: [549],
    },
    ...
    ComplexityEnum: {
      chatbots: [
        70,
        {
          distinctOn: [131, "[ChatbotSelectColumn!]"],
          limit: [172],
          offset: [172],
          orderBy: [129, "[ChatbotOrderBy!]"],
          where: [78],
        },
      ],
      chatbotsAggregate: [
    ...
    ComplexityEnumAggregateFields: {
      count: [
        172,
        {
          columns: [164, "[ComplexityEnumSelectColumn!]"],
          distinct: [0],
        },
      ],
      max: [157],
    ...
    LabelChatbotCategoryAggregateFields: {
      ...
      count: [
        172,
        {
          columns: [199, "[LabelChatbotCategorySelectColumn!]"],
          distinct: [0],
        },
      ],
      max: [191],
    ...
    LengthEnumAggregateFields: {
      count: [
        172,
        {
          columns: [255, "[LengthEnumSelectColumn!]"],
          distinct: [0],
        },
      ],
      max: [248],
    ...
    MessageAggregateFields: {
      count: [
        172,
        {
          columns: [278, "[MessageSelectColumn!]"],
          distinct: [0],
        },
      ],
      max: [270],
    ...
    MessageTypeEnum: {
      messages: [
        261,
        {
          distinctOn: [278, "[MessageSelectColumn!]"],
          limit: [172],
          offset: [172],
          orderBy: [276, "[MessageOrderBy!]"],
          where: [267],
        },
      ],
      messagesAggregate: [
    ...
    MessageTypeEnumAggregateFields: {
      count: [
        172,
        {
          columns: [295, "[MessageTypeEnumSelectColumn!]"],
          distinct: [0],
        },
      ],
      max: [288],
    ...
    ModelsEnumAggregateFields: {
      count: [
        172,
        {
          columns: [318, "[ModelsEnumSelectColumn!]"],
          distinct: [0],
        },
      ],
      max: [311],
    ...
    PreferenceAggregateFields: {
      ...
      count: [
        172,
        {
          columns: [345, "[PreferenceSelectColumn!]"],
          distinct: [0],
        },
      ],
      max: [337],
    ...
    Prompt: {
      ...
      users: [
        461,
        {
          distinctOn: [481, "[PromptUserSelectColumn!]"],
          limit: [172],
          offset: [172],
          orderBy: [479, "[PromptUserOrderBy!]"],
          where: [469],
        },
      ],
      usersAggregate: [
    ...
    PromptAggregateFields: {
      ...
      count: [
        172,
        {
          columns: [428, "[PromptSelectColumn!]"],
          distinct: [0],
        },
      ],
      max: [419],
    ...
    PromptChatbotAggregateFields: {
      ...
      count: [
        172,
        {
          columns: [396, "[PromptChatbotSelectColumn!]"],
          distinct: [0],
        },
      ],
      max: [388],
    ...
    PromptTypeEnum: {
      prompts: [
        367,
        {
          distinctOn: [428, "[PromptSelectColumn!]"],
          limit: [172],
          offset: [172],
          orderBy: [426, "[PromptOrderBy!]"],
          where: [375],
        },
      ],
      promptsAggregate: [
    ...
    PromptTypeEnumAggregateFields: {
      count: [
        172,
        {
          columns: [453, "[PromptTypeEnumSelectColumn!]"],
          distinct: [0],
        },
      ],
      max: [446],
    ...
    PromptUserAggregateFields: {
      ...
      count: [
        172,
        {
          columns: [481, "[PromptUserSelectColumn!]"],
          distinct: [0],
        },
      ],
      max: [473],
    ...
    ReferralAggregateFields: {
      count: [
        172,
        {
          columns: [524, "[ReferralSelectColumn!]"],
          distinct: [0],
        },
      ],
      max: [516],
    ...
    SocialFollowingAggregateFields: {
      count: [
        172,
        {
          columns: [544, "[SocialFollowingSelectColumn!]"],
          distinct: [0],
        },
      ],
      max: [538],
    ...
    ThreadAggregateFields: {
      ...
      count: [
        172,
        {
          columns: [572, "[ThreadSelectColumn!]"],
          distinct: [0],
        },
      ],
      max: [563],
    ...
    Token: {
      ...
      userTokens: [
        670,
        {
          distinctOn: [687, "[UserTokenSelectColumn!]"],
          limit: [172],
          offset: [172],
          orderBy: [685, "[UserTokenOrderBy!]"],
          where: [676],
        },
      ],
      userTokensAggregate: [
    ...
    ToneEnumAggregateFields: {
      count: [
        172,
        {
          columns: [627, "[ToneEnumSelectColumn!]"],
          distinct: [0],
        },
      ],
      max: [620],
    ...
    TypeEnumAggregateFields: {
      count: [
        172,
        {
          columns: [646, "[TypeEnumSelectColumn!]"],
          distinct: [0],
        },
      ],
      max: [639],
    ...
    User: {
      ...
      followers: [
        530,
        {
          distinctOn: [544, "[SocialFollowingSelectColumn!]"],
          limit: [172],
          offset: [172],
          orderBy: [543, "[SocialFollowingOrderBy!]"],
          where: [536],
        },
      ],
      followersAggregate: [
      ...
      referrals: [
        507,
        {
          distinctOn: [524, "[ReferralSelectColumn!]"],
          limit: [172],
          offset: [172],
          orderBy: [522, "[ReferralOrderBy!]"],
          where: [513],
        },
      ],
      referralsAggregate: [
    ...
    UserBoolExp: {
      ...
      favouriteTopic: [550],
      followers: [536],
      followersAggregate: [532],
      following: [536],
      followingAggregate: [532],
      getFreeMonth: [1],
      isBlocked: [1],
      isVerified: [1],
      lastLogin: [594],
      ...
      preferences: [333],
      preferencesAggregate: [327],
      proUserSubscriptionId: [550],
      profilePicture: [550],
      prompts: [469],
      promptsAggregate: [463],
      referrals: [513],
      referralsAggregate: [509],
      referralsByUserId: [513],
      referralsByUserIdAggregate: [509],
      role: [665],
      slug: [550],
      threads: [559],
      threadsAggregate: [553],
    ...
    UserOrderBy: {
      ...
      email: [324],
      favouriteTopic: [324],
      followersAggregate: [534],
      followingAggregate: [534],
      getFreeMonth: [324],
      isBlocked: [324],
      isVerified: [324],
      isVerified: [1],
      ...
      password: [324],
      preferencesAggregate: [329],
      proUserSubscriptionId: [324],
      profilePicture: [324],
      promptsAggregate: [465],
      referralsAggregate: [511],
      referralsByUserIdAggregate: [511],
      role: [324],
      slug: [324],
      threadsAggregate: [555],
      userId: [324],
    ...
    UserTokenAggregateFields: {
      count: [
        172,
        {
          columns: [687, "[UserTokenSelectColumn!]"],
          distinct: [0],
        },
      ],
      max: [679],
    ...
    Query: {
      ...
      complexityEnum: [
        151,
        {
          distinctOn: [164, "[ComplexityEnumSelectColumn!]"],
          limit: [172],
          offset: [172],
          orderBy: [162, "[ComplexityEnumOrderBy!]"],
          where: [154],
        },
      ],
      complexityEnumAggregate: [
      ...
      label: [
        174,
        {
          distinctOn: [229, "[LabelSelectColumn!]"],
          limit: [172],
          offset: [172],
          orderBy: [227, "[LabelOrderBy!]"],
          where: [178],
        },
      ],
      labelAggregate: [
      ...
      lengthEnum: [
        242,
        {
          distinctOn: [255, "[LengthEnumSelectColumn!]"],
          limit: [172],
          offset: [172],
          orderBy: [253, "[LengthEnumOrderBy!]"],
          where: [245],
        },
      ],
      lengthEnumAggregate: [
      ...
      messageTypeEnum: [
        282,
        {
          distinctOn: [295, "[MessageTypeEnumSelectColumn!]"],
          limit: [172],
          offset: [172],
          orderBy: [293, "[MessageTypeEnumOrderBy!]"],
          where: [285],
        },
      ],
      messageTypeEnumAggregate: [
      ...
      modelsEnum: [
        303,
        {
          distinctOn: [318, "[ModelsEnumSelectColumn!]"],
          limit: [172],
          offset: [172],
          orderBy: [316, "[ModelsEnumOrderBy!]"],
          where: [306],
        },
      ],
      modelsEnumAggregate: [
      ...
      promptTypeEnum: [
        440,
        {
          distinctOn: [453, "[PromptTypeEnumSelectColumn!]"],
          limit: [172],
          offset: [172],
          orderBy: [451, "[PromptTypeEnumOrderBy!]"],
          where: [443],
        },
      ],
      promptTypeEnumAggregate: [
      ...
      token: [
        595,
        {
          distinctOn: [608, "[TokenSelectColumn!]"],
          limit: [172],
          offset: [172],
          orderBy: [606, "[TokenOrderBy!]"],
          where: [598],
        },
      ],
      tokenAggregate: [
      ...
      token: [
        576,
        {
          distinctOn: [589, "[TokenSelectColumn!]"],
          limit: [172],
          offset: [172],
          orderBy: [587, "[TokenOrderBy!]"],
          where: [579],
        },
      ],
      tokenAggregate: [
      ...
      toneEnum: [
        614,
        {
          distinctOn: [627, "[ToneEnumSelectColumn!]"],
          limit: [172],
          offset: [172],
          orderBy: [625, "[ToneEnumOrderBy!]"],
          where: [617],
        },
      ],
      toneEnumAggregate: [
      ...
      typeEnum: [
        633,
        {
          distinctOn: [646, "[TypeEnumSelectColumn!]"],
          limit: [172],
          offset: [172],
          orderBy: [644, "[TypeEnumOrderBy!]"],
          where: [636],
        },
      ],
      typeEnumAggregate: [
      ...
      user: [
        652,
        {
          distinctOn: [666, "[UserSelectColumn!]"],
          limit: [172],
          offset: [172],
          orderBy: [663, "[UserOrderBy!]"],
          where: [655],
        },
      ],
      userAggregate: [
    ...
    Mutation: {
      ...
      deleteChatbotCategory: [
        95,
        {
          where: [87, "ChatbotCategoryBoolExp!"],
        },
      ],
      ...
      deleteComplexityEnum: [
        159,
        {
          where: [154, "ComplexityEnumBoolExp!"],
        },
      ],
      ...
      deleteLabelChatbotCategory: [
        195,
        {
          where: [187, "LabelChatbotCategoryBoolExp!"],
        },
      ],
      ...
      deleteMessageTypeEnum: [
        290,
        {
          where: [285, "MessageTypeEnumBoolExp!"],
        },
      ],
      ...
      deletePromptChatbot: [
        392,
        {
          where: [384, "PromptChatbotBoolExp!"],
        },
      ],
      ...
      deletePromptTypeEnum: [
        448,
        {
          where: [443, "PromptTypeEnumBoolExp!"],
        },
      ],
      ...
      deleteSocialFollowing: [
        542,
        {
          where: [536, "SocialFollowingBoolExp!"],
        },
      ],
      deleteThread: [
        567,
        {
          where: [559, "ThreadBoolExp!"],
        },
      ],
      deleteThreadByPk: [
        551,
      ...
      insertChatbot: [
        126,
        {
          objects: [121, "[ChatbotInsertInput!]!"],
          onConflict: [128],
        },
      ],
      insertChatbotCategory: [
        95,
        {
          objects: [90, "[ChatbotCategoryInsertInput!]!"],
          onConflict: [96],
        },
      ],
      insertChatbotCategoryOne: [
        79,
        {
          object: [90, "ChatbotCategoryInsertInput!"],
          onConflict: [96],
        },
      ],
      insertChatbotOne: [
      ...
      insertComplexityEnum: [
        159,
        {
          objects: [156, "[ComplexityEnumInsertInput!]!"],
          onConflict: [161],
        },
      ],
      insertComplexityEnumOne: [
        151,
        {
          object: [156, "ComplexityEnumInsertInput!"],
          onConflict: [161],
        },
      ],
      insertLabel: [
      ...
      insertLabelChatbotCategory: [
        195,
        {
          objects: [190, "[LabelChatbotCategoryInsertInput!]!"],
          onConflict: [196],
        },
      ],
      insertLabelChatbotCategoryOne: [
        179,
        {
          object: [190, "LabelChatbotCategoryInsertInput!"],
          onConflict: [196],
        },
      ],
      insertLabelOne: [
      ...
      insertLengthEnum: [
        250,
        {
          objects: [247, "[LengthEnumInsertInput!]!"],
          onConflict: [252],
        },
      ],
      insertLengthEnumOne: [
        242,
        {
          object: [247, "LengthEnumInsertInput!"],
          onConflict: [252],
        },
      ],
      insertMessage: [
        274,
        {
          objects: [269, "[MessageInsertInput!]!"],
          onConflict: [275],
        },
      ],
      insertMessageOne: [
      ...
      insertMessageTypeEnum: [
        290,
        {
          objects: [287, "[MessageTypeEnumInsertInput!]!"],
          onConflict: [292],
        },
      ],
      insertMessageTypeEnumOne: [
        282,
        {
          object: [287, "MessageTypeEnumInsertInput!"],
          onConflict: [292],
        },
      ],
      insertModelsEnum: [
        313,
        {
          objects: [310, "[ModelsEnumInsertInput!]!"],
          onConflict: [315],
        },
      ],
      insertModelsEnumOne: [
        303,
        {
          object: [310, "ModelsEnumInsertInput!"],
          onConflict: [315],
        },
      ],
      insertPreference: [
        341,
        {
          objects: [336, "[PreferenceInsertInput!]!"],
          onConflict: [342],
        },
      ],
      insertPreferenceOne: [
        325,
        {
          object: [336, "PreferenceInsertInput!"],
          onConflict: [342],
        },
      ],
      insertPrompt: [
      ...
      insertPromptChatbot: [
        392,
        {
          objects: [387, "[PromptChatbotInsertInput!]!"],
          onConflict: [393],
        },
      ],
      insertPromptChatbotOne: [
        376,
        {
          object: [387, "PromptChatbotInsertInput!"],
          onConflict: [393],
        },
      ],
      insertPromptOne: [
      ...
      insertPromptTypeEnum: [
        448,
        {
          objects: [445, "[PromptTypeEnumInsertInput!]!"],
          onConflict: [450],
        },
      ],
      insertPromptTypeEnumOne: [
        440,
        {
          object: [445, "PromptTypeEnumInsertInput!"],
          onConflict: [450],
        },
      ],
      insertPromptUser: [
        477,
        {
          objects: [472, "[PromptUserInsertInput!]!"],
          onConflict: [478],
        },
      ],
      insertPromptUserOne: [
        461,
        {
          object: [472, "PromptUserInsertInput!"],
          onConflict: [478],
        },
      ],
      insertReferral: [
        520,
        {
          objects: [515, "[ReferralInsertInput!]!"],
          onConflict: [521],
        },
      ],
      insertReferralOne: [
        507,
        {
          object: [515, "ReferralInsertInput!"],
          onConflict: [521],
        },
      ],
      insertSocialFollowing: [
        542,
        {
          objects: [537, "[SocialFollowingInsertInput!]!"],
        },
      ],
      insertSocialFollowingOne: [
        530,
        {
          object: [537, "SocialFollowingInsertInput!"],
        },
      ],
      insertThread: [
        567,
        {
          objects: [562, "[ThreadInsertInput!]!"],
          onConflict: [569],
        },
      ],
      insertThreadOne: [
      ...
      insertToneEnum: [
        622,
        {
          objects: [619, "[ToneEnumInsertInput!]!"],
          onConflict: [624],
        },
      ],
      insertToneEnumOne: [
        614,
        {
          object: [619, "ToneEnumInsertInput!"],
          onConflict: [624],
        },
      ],
      insertTypeEnum: [
        641,
        {
          objects: [638, "[TypeEnumInsertInput!]!"],
          onConflict: [643],
        },
      ],
      insertTypeEnumOne: [
        633,
        {
          object: [638, "TypeEnumInsertInput!"],
          onConflict: [643],
        },
      ],
      insertUser: [
      ...
      insertUserToken: [
        683,
        {
          objects: [678, "[UserTokenInsertInput!]!"],
          onConflict: [684],
        },
      ],
      insertUserTokenOne: [
        670,
        {
          object: [678, "UserTokenInsertInput!"],
          onConflict: [684],
        },
      ],
      updateCategory: [
      ...
      updateChatbotByPk: [
        70,
        {
          _inc: [120],
          _set: [132],
          pkColumns: [130, "ChatbotPkColumnsInput!"],
        },
      ],
      ...
      updateChatbotCategoryByPk: [
        79,
        {
          _inc: [89],
          _set: [100],
          pkColumns: [98, "ChatbotCategoryPkColumnsInput!"],
        },
      ],
      updateChatbotCategoryMany: [
        95,
        {
          updates: [112, "[ChatbotCategoryUpdates!]!"],
        },
      ],
      updateChatbotMany: [
        126,
        {
          updates: [144, "[ChatbotUpdates!]!"],
        },
      ],
      ...
      updateComplexityEnumByPk: [
        ...
        {
          _set: [165],
          pkColumns: [163, "ComplexityEnumPkColumnsInput!"],
        },
      ],
      updateComplexityEnumMany: [
        159,
        {
          updates: [169, "[ComplexityEnumUpdates!]!"],
        },
      ],
      updateLabel: [
        224,
      ...
      updateLabelByPk: [
        174,
        {
          _inc: [220],
          _set: [230],
          pkColumns: [228, "LabelPkColumnsInput!"],
        },
      ],
      ...
      updateLabelChatbotCategoryByPk: [
        179,
        {
          _inc: [189],
          _set: [200],
          pkColumns: [198, "LabelChatbotCategoryPkColumnsInput!"],
        },
      ],
      updateLabelChatbotCategoryMany: [
        195,
        {
          updates: [212, "[LabelChatbotCategoryUpdates!]!"],
        },
      ],
      updateLabelMany: [
        224,
        {
          updates: [238, "[LabelUpdates!]!"],
        },
      ],
      updateLengthEnum: [
        250,
      ...
      updateLengthEnumByPk: [
        ...
        {
          _set: [256],
          pkColumns: [254, "LengthEnumPkColumnsInput!"],
        },
      ],
      updateLengthEnumMany: [
        250,
        {
          updates: [260, "[LengthEnumUpdates!]!"],
        },
      ],
      updateMessage: [
        274,
      ...
      updateMessageByPk: [
        ...
        {
          _set: [279],
          pkColumns: [277, "MessagePkColumnsInput!"],
        },
      ],
      updateMessageMany: [
        274,
        {
          updates: [302, "[MessageUpdates!]!"],
        },
      ],
      ...
      updateMessageTypeEnumByPk: [
        ...
        {
          _set: [296],
          pkColumns: [294, "MessageTypeEnumPkColumnsInput!"],
        },
      ],
      updateMessageTypeEnumMany: [
        290,
        {
          updates: [300, "[MessageTypeEnumUpdates!]!"],
        },
      ],
      updateModelsEnum: [
        313,
      ...
      updateModelsEnumByPk: [
        ...
        {
          _set: [319],
          pkColumns: [317, "ModelsEnumPkColumnsInput!"],
        },
      ],
      updateModelsEnumMany: [
        313,
        {
          updates: [323, "[ModelsEnumUpdates!]!"],
        },
      ],
      updatePreference: [
        341,
      ...
      updatePreferenceByPk: [
        325,
        {
          _inc: [335],
          _set: [348],
          pkColumns: [344, "PreferencePkColumnsInput!"],
        },
      ],
      updatePreferenceMany: [
        341,
        {
          updates: [360, "[PreferenceUpdates!]!"],
        },
      ],
      updatePrompt: [
        423,
      ...
      updatePromptByPk: [
        367,
        {
          _inc: [417],
          _set: [429],
          pkColumns: [427, "PromptPkColumnsInput!"],
        },
      ],
      updatePromptChatbot: [
        392,
      ...
      updatePromptChatbotByPk: [
        376,
        {
          _inc: [386],
          _set: [397],
          pkColumns: [395, "PromptChatbotPkColumnsInput!"],
        },
      ],
      updatePromptChatbotMany: [
        392,
        {
          updates: [409, "[PromptChatbotUpdates!]!"],
        },
      ],
      updatePromptMany: [
        423,
        {
          updates: [460, "[PromptUpdates!]!"],
        },
      ],
      ...
      updatePromptTypeEnumByPk: [
        ...
        {
          _set: [454],
          pkColumns: [452, "PromptTypeEnumPkColumnsInput!"],
        },
      ],
      updatePromptTypeEnumMany: [
        448,
        {
          updates: [458, "[PromptTypeEnumUpdates!]!"],
        },
      ],
      updatePromptUser: [
        477,
      ...
      updatePromptUserByPk: [
        461,
        {
          _inc: [471],
          _set: [482],
          pkColumns: [480, "PromptUserPkColumnsInput!"],
        },
      ],
      updatePromptUserMany: [
        477,
        {
          updates: [494, "[PromptUserUpdates!]!"],
        },
      ],
      updateReferral: [
        520,
      ...
      updateReferralByPk: [
        ...
        {
          _set: [525],
          pkColumns: [523, "ReferralPkColumnsInput!"],
        },
      ],
      updateReferralMany: [
        520,
        {
          updates: [529, "[ReferralUpdates!]!"],
        },
      ],
      ...
      updateSocialFollowingMany: [
        542,
        {
          updates: [548, "[SocialFollowingUpdates!]!"],
        },
      ],
      updateThread: [
        567,
      ...
      updateThreadByPk: [
        551,
        {
          _inc: [561],
          _set: [575],
          pkColumns: [571, "ThreadPkColumnsInput!"],
        },
      ],
      updateThreadMany: [
        567,
        {
          updates: [587, "[ThreadUpdates!]!"],
        },
      ],
      updateToken: [
        603,
      ...
      updateTokenByPk: [
        ...
        {
          _set: [609],
          pkColumns: [607, "TokenPkColumnsInput!"],
        },
      ],
      updateTokenMany: [
        603,
        {
          updates: [613, "[TokenUpdates!]!"],
        },
      ],
      updateToneEnum: [
        622,
      ...
      updateToneEnumByPk: [
        ...
        {
          _set: [628],
          pkColumns: [626, "ToneEnumPkColumnsInput!"],
        },
      ],
      updateToneEnumMany: [
        622,
        {
          updates: [632, "[ToneEnumUpdates!]!"],
        },
      ],
      updateTypeEnum: [
        641,
      ...
      updateTypeEnumByPk: [
        ...
        {
          _set: [647],
          pkColumns: [645, "TypeEnumPkColumnsInput!"],
        },
      ],
      updateTypeEnumMany: [
        641,
        {
          updates: [651, "[TypeEnumUpdates!]!"],
        },
      ],
      updateUser: [
        660,
      ...
      updateUserByPk: [
        ...
        {
          _set: [667],
          pkColumns: [664, "UserPkColumnsInput!"],
        },
      ],
      updateUserMany: [
        660,
        {
          updates: [694, "[UserUpdates!]!"],
        },
      ],
      updateUserToken: [
        683,
      ...
      updateUserTokenByPk: [
        ...
        {
          _set: [688],
          pkColumns: [686, "UserTokenPkColumnsInput!"],
        },
      ],
      updateUserTokenMany: [
        683,
        {
          updates: [692, "[UserTokenUpdates!]!"],
        },
      ],
      __typename: [549],
    },
    Subscription: {
      ...
      chatbotCategoryStream: [
        ...
        {
          batchSize: [172, "Int!"],
          cursor: [107, "[ChatbotCategoryStreamCursorInput]!"],
          where: [87],
        },
      ],
      chatbotStream: [
        ...
        {
          batchSize: [172, "Int!"],
          cursor: [139, "[ChatbotStreamCursorInput]!"],
          where: [78],
        },
      ],
      complexityEnum: [
      ...
      complexityEnumStream: [
        ...
        {
          batchSize: [172, "Int!"],
          cursor: [166, "[ComplexityEnumStreamCursorInput]!"],
          where: [154],
        },
      ],
      label: [
      ...
      labelChatbotCategoryStream: [
        ...
        {
          batchSize: [172, "Int!"],
          cursor: [207, "[LabelChatbotCategoryStreamCursorInput]!"],
          where: [187],
        },
      ],
      labelStream: [
        ...
        {
          batchSize: [172, "Int!"],
          cursor: [234, "[LabelStreamCursorInput]!"],
          where: [178],
        },
      ],
      lengthEnum: [
      ...
      lengthEnumStream: [
        ...
        {
          batchSize: [172, "Int!"],
          cursor: [257, "[LengthEnumStreamCursorInput]!"],
          where: [245],
        },
      ],
      message: [
      ...
      messageStream: [
        ...
        {
          batchSize: [172, "Int!"],
          cursor: [280, "[MessageStreamCursorInput]!"],
          where: [267],
        },
      ],
      messageTypeEnum: [
      ...
      messageTypeEnumStream: [
        ...
        {
          batchSize: [172, "Int!"],
          cursor: [297, "[MessageTypeEnumStreamCursorInput]!"],
          where: [285],
        },
      ],
      modelsEnum: [
      ...
      modelsEnumStream: [
        ...
        {
          batchSize: [172, "Int!"],
          cursor: [320, "[ModelsEnumStreamCursorInput]!"],
          where: [306],
        },
      ],
      preference: [
      ...
      preferenceStream: [
        ...
        {
          batchSize: [172, "Int!"],
          cursor: [355, "[PreferenceStreamCursorInput]!"],
          where: [333],
        },
      ],
      prompt: [
      ...
      promptChatbotStream: [
        ...
        {
          batchSize: [172, "Int!"],
          cursor: [404, "[PromptChatbotStreamCursorInput]!"],
          where: [384],
        },
      ],
      promptStream: [
        ...
        {
          batchSize: [172, "Int!"],
          cursor: [436, "[PromptStreamCursorInput]!"],
          where: [375],
        },
      ],
      promptTypeEnum: [
      ...
      promptTypeEnumStream: [
        ...
        {
          batchSize: [172, "Int!"],
          cursor: [455, "[PromptTypeEnumStreamCursorInput]!"],
          where: [443],
        },
      ],
      promptUser: [
      ...
      promptUserStream: [
        ...
        {
          batchSize: [172, "Int!"],
          cursor: [489, "[PromptUserStreamCursorInput]!"],
          where: [469],
        },
      ],
      referral: [
      ...
      referralStream: [
        ...
        {
          batchSize: [172, "Int!"],
          cursor: [526, "[ReferralStreamCursorInput]!"],
          where: [513],
        },
      ],
      socialFollowing: [
      ...
      socialFollowingStream: [
        ...
        {
          batchSize: [172, "Int!"],
          cursor: [546, "[SocialFollowingStreamCursorInput]!"],
          where: [536],
        },
      ],
      thread: [
      ...
      threadStream: [
        ...
        {
          batchSize: [172, "Int!"],
          cursor: [582, "[ThreadStreamCursorInput]!"],
          where: [559],
        },
      ],
      token: [
      ...
      tokenStream: [
        ...
        {
          batchSize: [172, "Int!"],
          cursor: [610, "[TokenStreamCursorInput]!"],
          where: [598],
        },
      ],
      toneEnum: [
      ...
      toneEnumStream: [
        ...
        {
          batchSize: [172, "Int!"],
          cursor: [629, "[ToneEnumStreamCursorInput]!"],
          where: [617],
        },
      ],
      typeEnum: [
      ...
      typeEnumStream: [
        ...
        {
          batchSize: [172, "Int!"],
          cursor: [648, "[TypeEnumStreamCursorInput]!"],
          where: [636],
        },
      ],
      user: [
      ...
      userStream: [
        ...
        {
          batchSize: [172, "Int!"],
          cursor: [668, "[UserStreamCursorInput]!"],
          where: [655],
        },
      ],
      userToken: [
      ...
      userTokenStream: [
        ...
        {
          batchSize: [172, "Int!"],
          cursor: [689, "[UserTokenStreamCursorInput]!"],
          where: [676],
        },
      ],
      __typename: [549],
