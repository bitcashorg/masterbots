export default {
  scalars: [
    ...
    559, 578, 587, 598, 602, 613, 624, 636, 653, 665, 666, 667, 679, 692, 701,
    705, 711, 720, 724, 730, 739, 743, 749, 759, 770, 780, 784, 786, 795, 797,
    811, 813, 814,
  ],
  types: {
    Boolean: {},
    ...
    CategoryEnum: {
      ...
      subcategoryEnumsAggregate: [
        581,
        {
          distinctOn: [598, "[SubcategoryEnumSelectColumn!]"],
          limit: [243],
          offset: [243],
          orderBy: [596, "[SubcategoryEnumOrderBy!]"],
          where: [586],
        },
      ],
    ...
    CategoryEnumBoolExp: {
      ...
      subcategoryEnumsByCategoryDomainAggregate: [582],
      subcategory_enums: [586],
      subcategory_enumsAggregate: [582],
      __typename: [578],
    },
    ...
    CategoryEnumInsertInput: {
      ...
      domain_enum: [204],
      name: [578],
      subcategoryEnumsByCategoryDomain: [585],
      subcategory_enums: [585],
      __typename: [578],
    },
    ...
    CategoryEnumOrderBy: {
      ...
      domain_enum: [206],
      name: [336],
      subcategoryEnumsByCategoryDomainAggregate: [584],
      subcategory_enumsAggregate: [584],
      __typename: [578],
    },
    ...
    Chatbot: {
      ...
      threads: [
        644,
        {
          distinctOn: [665, "[ThreadSelectColumn!]"],
          limit: [243],
          offset: [243],
          orderBy: [663, "[ThreadOrderBy!]"],
          where: [652],
        },
      ],
      threadsAggregate: [
    ...
    DomainEnum: {
      ...
      tagEnumsAggregate: [
        605,
        {
          distinctOn: [624, "[TagEnumSelectColumn!]"],
          limit: [243],
          offset: [243],
          orderBy: [622, "[TagEnumOrderBy!]"],
          where: [612],
        },
      ],
      tag_enums: [
    ...
    Example: {
      ...
      response: [578],
      subcategory: [578],
      subcategoryEnumBySubcategoryCategoryDomain: [580],
      subcategory_enum: [580],
      tags: [814],
      __typename: [578],
    },
    ExampleAggregate: {
    ...
    ExampleBoolExp: {
      ...
      response: [579],
      subcategory: [579],
      subcategoryEnumBySubcategoryCategoryDomain: [586],
      subcategory_enum: [586],
      tags: [788],
      __typename: [578],
    },
    ExampleConstraint: {},
    ...
    ExampleInsertInput: {
      ...
      response: [578],
      subcategory: [578],
      subcategoryEnumBySubcategoryCategoryDomain: [594],
      subcategory_enum: [594],
      tags: [814],
      __typename: [578],
    },
    ExampleMaxFields: {
    ...
    ExampleOrderBy: {
      ...
      response: [336],
      subcategory: [336],
      subcategoryEnumBySubcategoryCategoryDomain: [596],
      subcategory_enum: [596],
      tags: [336],
      __typename: [578],
    },
    ...
    SubcategoryEnumAggregateFields: {
      count: [
        243,
        {
          columns: [598, "[SubcategoryEnumSelectColumn!]"],
          distinct: [0],
        },
      ],
      max: [589],
    ...
    TagEnumAggregateFields: {
      ...
      count: [
        243,
        {
          columns: [624, "[TagEnumSelectColumn!]"],
          distinct: [0],
        },
      ],
      max: [616],
    ...
    ThreadAggregateFields: {
      ...
      count: [
        243,
        {
          columns: [665, "[ThreadSelectColumn!]"],
          distinct: [0],
        },
      ],
      max: [656],
    ...
    Token: {
      ...
      userTokens: [
        763,
        {
          distinctOn: [780, "[UserTokenSelectColumn!]"],
          limit: [243],
          offset: [243],
          orderBy: [778, "[UserTokenOrderBy!]"],
          where: [769],
        },
      ],
      userTokensAggregate: [
    ...
    ToneEnumAggregateFields: {
      count: [
        243,
        {
          columns: [720, "[ToneEnumSelectColumn!]"],
          distinct: [0],
        },
      ],
      max: [713],
    ...
    TypeEnumAggregateFields: {
      count: [
        243,
        {
          columns: [739, "[TypeEnumSelectColumn!]"],
          distinct: [0],
        },
      ],
      max: [732],
    ...
    UserTokenAggregateFields: {
      count: [
        243,
        {
          columns: [780, "[UserTokenSelectColumn!]"],
          distinct: [0],
        },
      ],
      max: [772],
    ...
    Query: {
      ...
      token: [
        688,
        {
          distinctOn: [701, "[TokenSelectColumn!]"],
          limit: [243],
          offset: [243],
          orderBy: [699, "[TokenOrderBy!]"],
          where: [691],
        },
      ],
      tokenAggregate: [
      ...
      toneEnum: [
        707,
        {
          distinctOn: [720, "[ToneEnumSelectColumn!]"],
          limit: [243],
          offset: [243],
          orderBy: [718, "[ToneEnumOrderBy!]"],
          where: [710],
        },
      ],
      toneEnumAggregate: [
      ...
      typeEnum: [
        726,
        {
          distinctOn: [739, "[TypeEnumSelectColumn!]"],
          limit: [243],
          offset: [243],
          orderBy: [737, "[TypeEnumOrderBy!]"],
          where: [729],
        },
      ],
      typeEnumAggregate: [
      ...
      user: [
        745,
        {
          distinctOn: [759, "[UserSelectColumn!]"],
          limit: [243],
          offset: [243],
          orderBy: [756, "[UserOrderBy!]"],
          where: [748],
        },
      ],
      userAggregate: [
    ...
    Mutation: {
      ...
      deleteSubcategoryEnum: [
        593,
        {
          where: [586, "SubcategoryEnumBoolExp!"],
        },
      ],
      ...
      insertSubcategoryEnum: [
        593,
        {
          objects: [588, "[SubcategoryEnumInsertInput!]!"],
          onConflict: [595],
        },
      ],
      insertSubcategoryEnumOne: [
        580,
        {
          object: [588, "SubcategoryEnumInsertInput!"],
          onConflict: [595],
        },
      ],
      insertTagEnum: [
        620,
        {
          objects: [615, "[TagEnumInsertInput!]!"],
          onConflict: [621],
        },
      ],
      insertTagEnumOne: [
      ...
      insertToneEnum: [
        715,
        {
          objects: [712, "[ToneEnumInsertInput!]!"],
          onConflict: [717],
        },
      ],
      insertToneEnumOne: [
        707,
        {
          object: [712, "ToneEnumInsertInput!"],
          onConflict: [717],
        },
      ],
      insertTypeEnum: [
        734,
        {
          objects: [731, "[TypeEnumInsertInput!]!"],
          onConflict: [736],
        },
      ],
      insertTypeEnumOne: [
        726,
        {
          object: [731, "TypeEnumInsertInput!"],
          onConflict: [736],
        },
      ],
      insertUser: [
      ...
      insertUserToken: [
        776,
        {
          objects: [771, "[UserTokenInsertInput!]!"],
          onConflict: [777],
        },
      ],
      insertUserTokenOne: [
        763,
        {
          object: [771, "UserTokenInsertInput!"],
          onConflict: [777],
        },
      ],
      updateCategory: [
      ...
      updateSubcategoryEnumByPk: [
        ...
        {
          _set: [599],
          pkColumns: [597, "SubcategoryEnumPkColumnsInput!"],
        },
      ],
      updateSubcategoryEnumMany: [
        593,
        {
          updates: [603, "[SubcategoryEnumUpdates!]!"],
        },
      ],
      updateTagEnum: [
        620,
      ...
      updateTagEnumByPk: [
        604,
        {
          _inc: [614],
          _set: [625],
          pkColumns: [623, "TagEnumPkColumnsInput!"],
        },
      ],
      updateTagEnumMany: [
        620,
        {
          updates: [637, "[TagEnumUpdates!]!"],
        },
      ],
      updateThread: [
        660,
      ...
      updateThreadByPk: [
        644,
        {
          _inc: [654],
          _set: [668],
          pkColumns: [664, "ThreadPkColumnsInput!"],
        },
      ],
      updateThreadMany: [
        660,
        {
          updates: [680, "[ThreadUpdates!]!"],
        },
      ],
      updateToken: [
        696,
      ...
      updateTokenByPk: [
        ...
        {
          _set: [702],
          pkColumns: [700, "TokenPkColumnsInput!"],
        },
      ],
      updateTokenMany: [
        696,
        {
          updates: [706, "[TokenUpdates!]!"],
        },
      ],
      updateToneEnum: [
        715,
      ...
      updateToneEnumByPk: [
        ...
        {
          _set: [721],
          pkColumns: [719, "ToneEnumPkColumnsInput!"],
        },
      ],
      updateToneEnumMany: [
        715,
        {
          updates: [725, "[ToneEnumUpdates!]!"],
        },
      ],
      updateTypeEnum: [
        734,
      ...
      updateTypeEnumByPk: [
        ...
        {
          _set: [740],
          pkColumns: [738, "TypeEnumPkColumnsInput!"],
        },
      ],
      updateTypeEnumMany: [
        734,
        {
          updates: [744, "[TypeEnumUpdates!]!"],
        },
      ],
      updateUser: [
        753,
      ...
      updateUserByPk: [
        ...
        {
          _set: [760],
          pkColumns: [757, "UserPkColumnsInput!"],
        },
      ],
      updateUserMany: [
        753,
        {
          updates: [787, "[UserUpdates!]!"],
        },
      ],
      updateUserToken: [
        776,
      ...
      updateUserTokenByPk: [
        ...
        {
          _set: [781],
          pkColumns: [779, "UserTokenPkColumnsInput!"],
        },
      ],
      updateUserTokenMany: [
        776,
        {
          updates: [785, "[UserTokenUpdates!]!"],
        },
      ],
      __typename: [578],
    },
    Subscription: {
      ...
      subcategoryEnumStream: [
        ...
        {
          batchSize: [243, "Int!"],
          cursor: [600, "[SubcategoryEnumStreamCursorInput]!"],
          where: [586],
        },
      ],
      tagEnum: [
      ...
      tagEnumStream: [
        ...
        {
          batchSize: [243, "Int!"],
          cursor: [632, "[TagEnumStreamCursorInput]!"],
          where: [612],
        },
      ],
      thread: [
      ...
      threadStream: [
        ...
        {
          batchSize: [243, "Int!"],
          cursor: [675, "[ThreadStreamCursorInput]!"],
          where: [652],
        },
      ],
      token: [
      ...
      tokenStream: [
        ...
        {
          batchSize: [243, "Int!"],
          cursor: [703, "[TokenStreamCursorInput]!"],
          where: [691],
        },
      ],
      toneEnum: [
      ...
      toneEnumStream: [
        ...
        {
          batchSize: [243, "Int!"],
          cursor: [722, "[ToneEnumStreamCursorInput]!"],
          where: [710],
        },
      ],
      typeEnum: [
      ...
      typeEnumStream: [
        ...
        {
          batchSize: [243, "Int!"],
          cursor: [741, "[TypeEnumStreamCursorInput]!"],
          where: [729],
        },
      ],
      user: [
      ...
      userStream: [
        ...
        {
          batchSize: [243, "Int!"],
          cursor: [761, "[UserStreamCursorInput]!"],
          where: [748],
        },
      ],
      userToken: [
      ...
      userTokenStream: [
        ...
        {
          batchSize: [243, "Int!"],
          cursor: [782, "[UserTokenStreamCursorInput]!"],
          where: [769],
        },
      ],
      __typename: [578],
