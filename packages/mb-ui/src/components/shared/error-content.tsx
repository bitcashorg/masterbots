...
import { ErrorAnim } from 'mb-lib/animations'
...
export function ErrorContent() {
	...
	return (
		<div className="flex flex-col w-full min-h-[480px] justify-center items-center inner-content  dark:bg-[url(/success-bg-dark.png)] bg-[url(/success-bg.png)] my-auto ">
			...
			<div className="flex flex-col w-[300px] text-black dark:text-white text-center">
				<h2 className="font-medium text-[24px] ">
					Failed to process your subscription payment:
				</h2>
