...
export const appConfig = {
  features: {
    ...
    maxAttachments: Number.parseInt(process.env.NEXT_PUBLIC_MAX_ATTACHMENTS || '10', 10),
    maxFileSize: Number.parseInt(process.env.NEXT_PUBLIC_MAX_FILE_SIZE || '10485760', 10),
  },
  enableAuth: {
