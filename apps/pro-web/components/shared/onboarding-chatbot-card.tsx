...
export function OnboardingChatbotCard({
	...
	return (
		...
		>
			<Card className="w-full max-w-screen-lg mx-auto relative z-10 overflow-hidden rounded-2xl border-2 shadow-lg backdrop-blur-sm bg-white/95 dark:bg-[#09090B]/95 transition-all duration-300 ease-in-out hover:shadow-xl">
