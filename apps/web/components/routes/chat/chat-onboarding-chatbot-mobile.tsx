...
export function OnboardingMobileView() {
	...
	return (
		...
		>
			<Card className="w-full relative bg-white dark:bg-[#09090B] overflow-hidden border-2 shadow-lg backdrop-blur-sm bg-white/95 dark:bg-[#09090B]/95 transition-all duration-300 ease-in-out hover:shadow-xl">
