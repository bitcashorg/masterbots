        ...
        >
          ...
          >
            ...
            >
              ...
              <p  style={{ color: '#ef4444', fontSize: '18px', marginTop: '0px' }}> {thread.chatbot.categories[0]?.category.name}</p>
              <h1 style={{ fontSize: '64px',lineHeight:"75px", color: 'white', overflow: 'hidden', textOverflow: 'ellipsis', display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical', maxHeight: '3.6em' }}>{question}</h1>
              <p style={{ fontSize: '24px', color: 'white', overflow: 'hidden', textOverflow: 'ellipsis', display: '-webkit-box', WebkitLineClamp: 3, WebkitBoxOrient: 'vertical', maxHeight: '96px' }}>{answer}</p>
