    ...
    >
      ...
      {!isThread && index === 0 ? (
        ...
        <div className={cn('flex flex-col items-start gap-2')}>
          ...
          <AttachmentCards userAttachments={userAttachments} isAccordionFocused={isAccordionFocused}/>
        </div>
      )}
      {/* Thread Description */}
      {isThread ? (
        ...
        {isPrevious && index === 0 ? (
          <>
            ...
            <div className="pb-3 mt-4 overflow-hidden opacity-50">
              Continued from <b>&ldquo;{pair.userMessage.content.trim()}&rdquo;</b> thread
