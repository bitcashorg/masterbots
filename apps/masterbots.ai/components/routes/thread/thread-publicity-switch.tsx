  ...
  return (
    ...
    >
      <Switch.Thumb
        ...
        className={cn('w-[32px] h-[32px] pr-4 bg-gray-100 dark:bg-gray-800 rounded-full transform transition-transform duration-100 ease-in-out', isPublic ? 'translate-x-[28px]' : '')}
      />
