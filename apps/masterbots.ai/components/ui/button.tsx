...
const buttonVariants = cva(
	'inline-flex items-center justify-center text-sm font-medium shadow ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 gap-2.5',
	{
		variants: {
			variant: {
				default:
				...
				outline:
					'border border-input hover:bg-muted hover:text-muted-foreground hover:border-muted-foreground/50',
				secondary:
