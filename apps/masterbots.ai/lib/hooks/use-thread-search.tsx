...
const ThreadSearchContext = React.createContext<ThreadSearchContextProps | undefined>(undefined)

export function useThreadSearch() {
  const context = React.useContext(ThreadSearchContext)
  if (!context) {
    throw new Error('useThreadSearch must be used within a ThreadSearchProvider')
  }
  return context
}
